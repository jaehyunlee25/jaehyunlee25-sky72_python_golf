...
const courses = { 
	대한: '9336aeb7-cdb2-11ec-a93e-0242ac11000a', // '대한 코스', 
	민국: '9336b0ed-cdb2-11ec-a93e-0242ac11000a', // '민국 코스', 
	통일: '9336b126-cdb2-11ec-a93e-0242ac11000a', // '통일 코스', 
};
...
function mneCallDetail(arrDate) {
	...
	param['ctl00$contents$ScptManager'] = 'ctl00$Content$ScptManager|ctl00$Content$btnUp';	// 매우 중요. 생략금지!!!
	param['__EVENTTARGET'] = 'ctl00$Content$btnUp';	// 매우 중요. 생략금지!!!
    ...
    ifr.innerHTML = data;
		...
		Array.from(els).forEach((el, i) => {
			...
			const fee_normal = el.children[5].innerText.ct(1).split(',').join('') * 1;
