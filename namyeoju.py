...
l = open('namyeoju_login.js', 'r')
lcon = l.read()
l.close()

driver.get('https://www.namyeoju.co.kr/Member/Login.aspx')
...
while True:
    ...
    driver.get('https://www.namyeoju.co.kr/main/Default.aspx')
