...
const courses = { 
	PARK: '6809d971-cdb8-11ec-a93e-0242ac11000a', // '파크 코스', 
	VALLEY: '6809dbb2-cdb8-11ec-a93e-0242ac11000a', // '밸리 코스'
};
...
function mneCallDetail(arrDate) {
	...
	param['ctl00$contents$ScptManager'] = 'ctl00$contents$ScptManager|ctl00$contents$lnkBtnUpd';	// 매우 중요. 생략금지!!!
	param['__EVENTTARGET'] = 'ctl00$contents$lnkBtnUpd';	// 매우 중요. 생략금지!!!
